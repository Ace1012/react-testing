interface ICustomerFilledCircleOutlineProps {
    fill?: string;
}
...
const CustomerFilledCircleOutline = ({ fill = "white" }: ICustomerFilledCircleOutlineProps) => {
    return (
        <svg style={STYLES} width="32px" height="32px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <title>MenuIconCustomerFilledCircleOutline32</title>
            <g id="MenuIconCustomerFilledCircleOutline32" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="iconmonstr-user-20" transform="translate(4.000000, 4.000000)" fill="#4A4A4A">
