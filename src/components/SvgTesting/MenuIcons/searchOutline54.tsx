interface ISearchOutline54Props {
    fill?: string;
}

const SearchOutline54 = ({ fill = "white" }: ISearchOutline54Props) => {
    return (
        <svg width="54px" height="54px" viewBox="0 0 54 54" version="1.1" xmlns="http://www.w3.org/2000/svg" >
            ...
            <g id="MenuIconSearchOutline54" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <mask id="mask-2" fill="white">
                    <use href="#path-2"></use>
                </mask>
                <use id="Shape" fill={fill} fill-rule="nonzero" href="#path-2"></use>
            </g>
        </svg>
    )
}
